//
//  TextCategoryCard.swift
//  Shortify Actions
//
//  Created by Lorenzo Ferrante on 07/01/21.
//

import SwiftUI

struct TextCategoryCard: View {
...
struct TextCategoryCard_Previews: PreviewProvider {
    let fontAwesomeSwiftUI = Font.custom("FontAwesome5Free-Regular", size: 20.0)
    static var previews: some View {
        TextCategoryCard(title: .constant("New Category"), icon: .constant(""), colorType: .constant(.Blue))
    }
}
